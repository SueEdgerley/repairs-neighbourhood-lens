...
function isIssueType(value: string | null): value is IssueType {
  return ISSUE_OPTIONS.some((option) => option.id === value);
}
    ...
    <>
      ...
      <main id="main-content" className="mx-auto max-w-lg px-4 py-8 sm:px-6 sm:py-10">
        <header className="space-y-2">
          <h1 className="text-3xl font-bold leading-tight text-council-navy">Report a Repair Concern</h1>
          <p className="text-base text-text-muted">
            Tell us about a repair problem — incomplete work, recurring issues, or poor workmanship.
            Choose your concern and tell us what happened.
          </p>
        </header>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-8" noValidate>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="For example: a repair was completed but the problem has come back."
            />
          </div>
